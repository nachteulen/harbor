...
logger = Logger.make_logger('ipaws-load-pipe')
...
def _work(filepath: str) -> None:
    ...
    s3.meta.client.copy(copy_source, bucket, f'stage/ipaws/alerts/snowpipe/{filename}')


if __name__ == '__main__':
    load_pipe({'FileName': 'baikal-development/stage/ipaws/snowpipe/2021-10-05T18:42:16Z.csv'}, None)
