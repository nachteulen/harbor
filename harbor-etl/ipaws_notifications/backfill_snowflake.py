...
logger = Logger.make_logger('backfill-notifications')
s3 = boto3.client('s3')
...
def _work(s3_path: str) -> None:
    ...
    for page in pages:
        for obj in page['Contents']:
            ...
            lc.invoke(FunctionName='IPAWSPrepSnowpipeNotifications',
                      InvocationType='Event',
                      Payload=json.dumps(lambda_payload))


if __name__ == '__main__':
    backfill({'s3_path': 'raw/ipaws/notifications/2021/10/25'}, None)
